...
public class MonthStatisticsFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.achievement_month,container,false);
    }
    ...
    public void onResume() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String todayOrderInfo = HttpRequest.sendGet(getString(R.string.httpsUrl) + "GetDateStatistics","distributorPhone=" + distributorPhone + "&dateType=" + "month");
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //显示订单数
                        TextView tv_monthOrderNum = getActivity().findViewById(R.id.tv_monthOrderNum);
                        tv_monthOrderNum.setText(orderNum + "");

                        //显示警告次数
                        TextView tv_monthWarnNum = getActivity().findViewById(R.id.tv_monthWarnNum);
                        tv_monthWarnNum.setText(disWarnNum + "");

                        TextView tv_monthRanking = getActivity().findViewById(R.id.tv_monthRanking);
                        tv_monthRanking.setText("本月排名：第 1 名");
